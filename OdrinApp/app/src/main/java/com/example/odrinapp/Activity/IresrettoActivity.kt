...
class IresrettoActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drinnkName.text = "Risretto"
        Glide.with(this)
            .load(R.drawable.irisretto)
            .into(imageView)


        addtoCart.setOnClickListener {
            val intent = Intent(this@IresrettoActivity, SummaryActivity::class.java)
        ...
        minusquantity.setOnClickListener {
            ...
            if (quantity == 0) {
                Toast.makeText(this@IresrettoActivity, "Can't decrease quantity below 0", Toast.LENGTH_SHORT).show()
            } else {
                quantity--
                displayQuantity()
                val coffeePrice = basePrice * quantity
    ...
    private fun saveCart() {
        ...
        if (mCurrentCartUri == null) {
            ...
            if (newUri == null) {
                Toast.makeText(this@IresrettoActivity, "Failed to add to Cart", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@IresrettoActivity, "Success adding to Cart", Toast.LENGTH_SHORT).show()
            }
        }
