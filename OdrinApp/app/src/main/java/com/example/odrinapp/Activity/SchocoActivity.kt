...
class SchocoActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drinnkName.text = "Choco Caliente"
        imageView.setImageResource(R.drawable.schococ)

        addtoCart.setOnClickListener {
            val intent = Intent(this@SchocoActivity, SummaryActivity::class.java)
        ...
        minusquantity.setOnClickListener {
            ...
            if (quantity == 0) {
                Toast.makeText(this@SchocoActivity, "Can't decrease quantity below 0", Toast.LENGTH_SHORT).show()
            } else {
                quantity--
                displayQuantity()
                val coffeePrice = basePrice * quantity
    ...
    private fun saveCart() {
        ...
        val values = ContentValues().apply {
            ...
            // Add the "image" value here
            put(OrderContract.OrderEntry.COLUMN_IMAGE, R.drawable.schococ)
