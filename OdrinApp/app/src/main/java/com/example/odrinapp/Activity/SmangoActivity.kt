...
class SmangoActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drinnkName.text = "Mango Agua Fresca"
        imageView.setImageResource(R.drawable.smango)

        addtoCart.setOnClickListener {
            val intent = Intent(this@SmangoActivity, SummaryActivity::class.java)
        ...
        minusquantity.setOnClickListener {
            ...
            if (quantity == 0) {
                Toast.makeText(this@SmangoActivity, "Can't decrease quantity below 0", Toast.LENGTH_SHORT).show()
            } else {
                quantity--
                displayQuantity()
                val coffeePrice = basePrice * quantity
    ...
    private fun saveCart() {
        ...
        if (mCurrentCartUri == null) {
            ...
            if (newUri == null) {
                Toast.makeText(this@SmangoActivity, "Failed to add to Cart", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@SmangoActivity, "Success adding to Cart", Toast.LENGTH_SHORT).show()
            }
        }
