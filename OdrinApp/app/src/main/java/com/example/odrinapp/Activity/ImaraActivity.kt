...
class ImaraActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drinnkName.text = "Marashchino"
        imageView.setImageResource(R.drawable.imaraschino)

        addtoCart.setOnClickListener {
            val intent = Intent(this@ImaraActivity, SummaryActivity::class.java)
        ...
        minusquantity.setOnClickListener {
            ...
            if (quantity == 0) {
                Toast.makeText(this@ImaraActivity, "Can't decrease quantity below 0", Toast.LENGTH_SHORT).show()
            } else {
                quantity--
                displayQuantity()
                val coffeePrice = basePrice * quantity
    ...
    private fun saveCart() {
        ...
        if (mCurrentCartUri == null) {
            ...
            if (newUri == null) {
                Toast.makeText(this@ImaraActivity, "Failed to add to Cart", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@ImaraActivity, "Success adding to Cart", Toast.LENGTH_SHORT).show()
            }
        }
